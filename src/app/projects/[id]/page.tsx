      ...
      <div className="mx-auto max-w-7xl space-y-12 px-6 py-24">
        ...
        <header className="flex flex-col gap-8 relative">
          ...
          <div className="flex flex-wrap items-end justify-between gap-8 pb-10 border-b border-white/5 relative z-10">
            <div className="space-y-4">
              <Link href="/projects" className="inline-flex items-center gap-2 group text-[10px] font-bold uppercase tracking-[0.3em] text-white/30 hover:text-accent transition-all">
            ...
            <GlassCard className="p-6! border-accent/20 bg-accent/2 min-w-[320px] shadow-2xl">
              ...
              <div className="flex gap-2 items-center mb-3">
                <div className="flex-1 bg-black/40 rounded-xl border border-white/5 p-3 text-[10px] font-sans font-bold text-white/40 truncate">
                  {portalUrl}
                </div>
                <a
                  href={portalUrl}
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-xl bg-accent/10 text-accent border border-accent/20 hover:bg-accent/20 transition-all font-bold text-[10px] uppercase tracking-widest"
                >
                  View Portal
                </a>
              </div>
              <div className="flex items-center gap-2 text-[8px] text-white/20 font-bold uppercase tracking-widest italic px-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 relative z-10">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-[10px] font-sans font-bold text-white/10 uppercase tracking-widest ml-auto">{workingFiles.length} Files</span>
                    ...
                    <div className="flex items-center justify-between gap-6">
                      <div className="flex items-center gap-4 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-[10px] font-sans font-bold text-white/20 uppercase tracking-widest">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-[10px] font-sans font-bold text-accent-warm/40 uppercase tracking-widest ml-auto">{deliverables.length} Files</span>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4 mb-2">
              <h2 className="text-[10px] font-bold text-white/20 uppercase tracking-[0.3em]">Client Feedback</h2>
              <div className="h-px flex-1 bg-white/5" />
            </div>

            <GlassCard className="p-8! bg-white/2 group transition-all">
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-white/5">
                <span className="text-[10px] font-bold text-white/40 uppercase tracking-[0.3em]">Recent Notes</span>
                <span className="px-3 py-1 rounded-lg bg-white/5 text-[10px] font-sans font-bold text-white/60">
                  ...
                  {project.feedbacks.map((fb) => (
                    ...
                    >
                      ...
                      <div className="flex justify-between items-start mb-4 gap-4">
                        <span className="text-[8px] font-sans font-bold text-white/20 uppercase tracking-widest">
                      ...
                      {fb.resolved && (
                        <div className="mt-4 flex items-center gap-2">
                          ...
                          <span className="text-[8px] font-bold uppercase tracking-[0.3em] text-accent">Resolved</span>
                        </div>
                      )}
                    </div>
                  ))}
